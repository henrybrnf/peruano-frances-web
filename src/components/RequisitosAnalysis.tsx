...
export default function RequisitosAnalysis() {
  ...
  const edtDictionaryData: EDTWorkPackage[] = [
    ...
    },
    {
      id: "1.5.2",
      controlAccount: "1.5",
      titulo: "Manual del Usuario (Docentes)",
      responsable: "Henry B. Nuñez Figueroa",
      fecha: "Junio 2026",
      descripcion: "Elaboración de la guía instructiva instructiva no-técnica simplificada para el uso del portal web, lectura QR, interpretación de gráficos semáforos de riesgo y bitácoras.",
      criterioAceptacion: "La redacción usará terminología humana, con capturas reales de la interfaz recopiladas e instructivos de resolución de incidentes llanos.",
      entregables: "Manual del Usuario en PDF portable provisto de índice, glosario y capturas de pantallas simplificado.",
      supuestos: "La interfaz gráfica se halla congelada en código y estable antes de confeccionar las capturas del instructivo.",
      recursos: "1 Redactor técnico, Computadora con procesador de informes.",
      duracion: "5 días hábiles",
    ...
    },
    {
      id: "1.5.3",
      controlAccount: "1.5",
      titulo: "Manual Técnico (TI de la IEP)",
      responsable: "Helber J. Perez Gutierrez",
      fecha: "Junio 2026",
      descripcion: "Confección de la guía técnica que especifica el modelo de datos físico de la base PostgreSQL, llamadas backend y comandos para el reentrenamiento del clasificador Python.",
      criterioAceptacion: "El personal de Sistemas de la institución debe ser capaz de recrear, actualizar o reiniciar el sistema de manera autónoma siguiendo exclusivamente la documentación del manual.",
      entregables: "Manual Técnico del sistema SIA-T en PDF provisto de diagramas de arquitectura de red.",
      supuestos: "El encargado de sistemas del colegio cuenta con conocimientos elementales en contenedores Docker y consultas SQL.",
      recursos: "1 Redactor técnico de ingeniería, Diagramador de base de datos relacional.",
      duracion: "5 días hábiles",
      categoria: "Capacitación"
    },
    {
